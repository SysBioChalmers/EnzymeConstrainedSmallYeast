function solution = solveLinMin(model, silent, epsilon)
    %My implementation of pFBA, finds the optimal solution using solveLin
    %constrains the solution to this value and runs a second optimization
    %to minimize the sum of the absolutevalue of the fluxes.
    %This is done by adding reversed versions of all reactions and minimizing
    %the sum of fluxes.
    if nargin <3
        epsilon = 0;
    end
