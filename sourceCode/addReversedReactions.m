function newModel = addReversedReactions(model)
    %makes model ireversible by adding reversed copies of reversible
    %reactions.It takes specifc care to not reverse the MassConstraint
    %since that would give negative mass for back fluxes.
