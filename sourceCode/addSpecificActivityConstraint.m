function model = addSpecificActivityConstraint(model, cParam, bondParam, time)
    %Calculates the amount of protein required for flux from the specific
    %activity, saturation parameters (cParam), and time (Specific activity
    %= mmol g-1 min-1, simulation data typically mol/h
